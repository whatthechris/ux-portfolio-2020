      ...
      <div className="page-container">
        ...
        <div className="wayfinder__case-study">
          ...
          <FullWidth
            leftlayout={true}
            small_image={true}
            heading="How Canadians view their finances"
          ...
          <VideosSection
            ...
            caption1="First, users are taken through an onboarding process where they fill out their account information, set a retirement goal and complete an Investment Personality Questionnaire (IPQ) to determine their investment risk appetite."
            ...
            heading="Like a crystal ball for your finances"
          ...
          <FullWidth
            heading="Results"
            paragraph="Throughout the testing of the final designs, it was clear that the users felt empowered and more confident about planning their retirement. This was mainly due to our successfully integration of low-touch self-directed and high-touch advisor guidance into one cohesive experience. It was also good for GWL's business by positioning itself as the financial provider for wealth products and eventually protection, retirement income and cash flow products as well. By soft selling their plan members to increase their RRSP contributions, GWL effectively brings more assets under their management. Finally, all our efforts paid off as Wayfinder was well received by both GWL stakeholders and members at launch."
          />
          ))}
        </div>
      </div>
