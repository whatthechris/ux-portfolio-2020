...
const HomepageHero = () => (
  <div className="homepage-hero">
    <div className="homepage-hero__intro">
      ...
      <p className="homepage-hero__paragraph">I’m a designer that codes, an animator that illustrates and a life-long learner that teaches. I use this unique combination of skills to create exciting and thoughtful digital experiences focusing on the needs of real people.</p>
